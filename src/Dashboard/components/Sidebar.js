            ...
            <aside className="navbar-aside" id="offcanvas_aside">
                ...
                <nav>
                    <ul className="menu-aside">
                        ...
                        {/*menu credit*/}
                        <li className={`menu-item ${pageName === 'subscriptions' ? 'active' : ''}`}>
                        ...
                        {/*menu loan*/}
                        <li className={`menu-item ${pageName === 'storetract-credit' ? 'active' : ''}`}>
                        ...
                        {/*menu settings*/}
                        <hr/>
                        <li className={`menu-item ${pageName === 'settings' ? 'active' : ''}`}>
                        ...
                        <li className="menu-item">
                            <Link to="/johnson-enterprises" className="menu-link">
                        ...
                        {/*view connect*/}
                        <li className={`menu-item ${pageName === 'help-desk' ? 'active' : ''}`}>
